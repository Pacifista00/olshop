...
export default function About() {
  return (
    <>
      ...
      {/* Visi Misi */}
      <section className="max-w-7xl mx-auto px-6 py-4 pb-10 grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-8 rounded-2xl shadow">
          ...
          <ul className="text-gray-600 space-y-2 list-disc list-inside">
            ...
            <li>Menghadirkan pengiriman cepat dan dapat diandalkan.</li>
      ...
      <section className="max-w-7xl mx-auto px-6 py-4 pb-10">
        ...
        <div className="w-full grid md:grid-cols-3 gap-8">
          <div className="p-8 bg-gray-100 rounded-2xl shadow text-center">
          ...
          <div className="p-8 bg-gray-100 rounded-2xl shadow text-center">
            ...
            <h3 className="font-semibold text-xl mb-2">Transaksi Aman</h3>
            <p className="text-gray-600">
          ...
          <div className="p-8 bg-gray-100 rounded-2xl shadow text-center">
            ...
            <h3 className="font-semibold text-xl mb-2">Produk Terpercaya</h3>
            <p className="text-gray-600">
      ...
      {/* Kontak */}
      <section className="max-w-7xl mx-auto px-6 py-4 pb-10">
        <h2 className="text-3xl font-bold text-center mb-12">Kontak</h2>
        <div className="grid md:grid-cols-3 gap-8 text-gray-700">
          <div className="bg-white p-8 rounded-2xl shadow flex items-start gap-4">
