  ...
  return (
    <div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-2 pb-10 text-center pt-44 md:pt-40">
        <SubHeadingCenter>Tentang Kami</SubHeadingCenter>

        <p className="max-w-2xl mx-auto text-md lg:text-lg">
      ...
      <section className="max-w-7xl mx-auto px-6 py-2 pb-10 grid md:grid-cols-2 gap-6">
        <div className="bg-white p-4 lg:p-8 rounded-2xl shadow">
          <SubHeading>Visi Kami</SubHeading>
        ...
        <div className="bg-white p-4 lg:p-8 rounded-2xl shadow">
          <SubHeading>Misi Kami</SubHeading>
          <ul className="space-y-2 list-disc pl-5 text-xs lg:text-sm">
      ...
      <section className="max-w-7xl mx-auto px-6 py-4 pb-10">
        <SubHeadingCenter>Mengapa Memilih Kami?</SubHeadingCenter>
      ...
      {/* Kontak */}
      <section className="max-w-7xl mx-auto px-6 py-4 pb-10">
        <SubHeadingCenter>Kontak</SubHeadingCenter>
